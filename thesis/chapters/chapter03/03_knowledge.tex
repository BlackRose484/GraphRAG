...
Nền tảng tri thức của hệ thống kế thừa từ ontology về nghệ thuật Chèo trong khóa luận tốt nghiệp của chị Trương Quỳnh Giang. Ontology được hình thức hoá theo chuẩn OWL, là cơ sở lý thuyết phù hợp để xây dựng nên đồ thị tri thức phục vụ cho hệ thống truy xuất thông tin.
...
Đồ thị mở rộng đã lưu trữ được toàn bộ tri thức tường minh, nhưng một phần tri thức ngầm - gồm các quan hệ chỉ hiện ra qua chuỗi liên kết nhiều bước và các quy ước nghệ thuật chưa được định nghĩa rõ ràng - không truy xuất được trực tiếp. Hệ thống bổ sung thêm 14 luật suy diễn được áp dụng lên đồ thị tại thời điểm xây dựng, chia thành ba nhóm theo chức năng. Toàn bộ luật được phát biểu hình thức bằng Semantic Web Rule Language (SWRL)  hoặc SPARQL CONSTRUCT và liệt kê tại Phụ lục~B.

\textit{Nhóm A} (gồm 4 luật A.1-A.4) đóng vai trò kiểm tra chất lượng dữ liệu một cách tự động. Trên một ontology xây dựng thủ công với hàng trăm thực thể, các vi phạm như giới tính nhân vật không khớp giới tính của đặc trưng nhân vật (Đào/Mụ) hay nhân vật thiếu phân loại vai diễn rất khó được phát hiện thông qua việc duyệt thủ công. Nhóm luật này có nhiệm vụ rà soát toàn bộ đồ thị và gắn nhãn các cá thể vi phạm để yêu cầu xử lý trước khi xuất ra đồ thị tri thức hoàn chỉnh. Tiêu biểu, luật \textit{Orphaned Appearance Detection} (A.4) đã phát hiện 17 lượt Appearance tồn tại trong ontology gốc nhưng không được liên kết với bất kỳ vai diễn nào - một vấn đề chất lượng dữ liệu mà người soạn ontology không nhận ra trong quá trình xây dựng.

\textit{Nhóm B} (gồm 7 luật B.1-B.7) phục vụ mục tiêu rút gọn cấu trúc đồ thị nhằm hỗ trợ truy xuất với tốc độ nhanh hơn. Nhiều câu hỏi của người dùng đòi hỏi truy xuất các quan hệ chỉ tồn tại dưới dạng chuỗi liên kết nhiều bước trong đồ thị tri thức cơ sở, làm tăng độ phức tạp của truy vấn Cypher và đẩy cao độ trễ truy xuất. Các luật trong nhóm này tính sẵn những quan hệ phái sinh đó và lưu chúng thành các cạnh tường minh trên đồ thị. Chẳng hạn, luật \textit{Direct Performs Relation} (B.2) vật chất hoá quan hệ giữa diễn viên và nhân vật - vốn phải đi qua nút trung gian \texttt{RoleAssignment} - thành cạnh \texttt{PERFORMS} một bước, qua đó đưa độ sâu duyệt từ 3-5 bước xuống còn 1 bước cho các truy vấn tương ứng.
